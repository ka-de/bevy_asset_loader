...
| [`progress_tracking.rs`](progress_tracking.rs)             | How to set up progress tracking using `bevy_progress`                    |
...
_ Low poly fox [by PixelMannen] (CC0 1.0 Universal)
_ Rigging and animation [by @tomkranis on Sketchfab] ([CC-BY 4.0])
